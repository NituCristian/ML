# -*- coding: utf-8 -*-
"""Decision_tree_loan_dataset.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1kdYcXXt4Hnc16kUE-U9cy9RX9S56q0W7
"""
...
undersample_rf = DecisionTreeClassifier().fit(undersample_x_train, undersample_y_train)
...
training_set = pd.concat([X_train, y_train], axis=1)
# Separating classes
gender = training_set[training_set.Gender == 1]
not_gender = training_set[training_set.Gender == 0]

# Undersampling the majority
undersample = resample(not_gender, 
                       replace=True, 
                       n_samples=len(gender), #set the number of samples to equal the number of the minority class
                       random_state=42)
# Returning to new training set
undersample_train = pd.concat([gender, undersample])
